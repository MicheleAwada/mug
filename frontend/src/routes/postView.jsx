        ...
        <div id="post-container">
            ...
            <section className="my-8 mx-20" id="detail-post-view">
                ...
                <div className="flex items-center gap-3 mb-8">
                    <img className="author-image w-14 h-14 object-cover rounded-full" src="http://placekitten.com/200/201" />
                    <p className="text-lg text-gray-800">Author Name</p>
                </div>

                <img className="post-image object-cover mx-auto rounded-md mb-8" src="https://blog.hubspot.com/hs-fs/hubfs/how-to-start-coding-1.jpg?width=595&height=400&name=how-to-start-coding-1.jpg" />
